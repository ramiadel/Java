package rami.adel.abdulrazek.application;
...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {
		...
		try {
                    ...
                    primaryStage.getIcons().add(new Image(getClass().getResourceAsStream("resources/images/ttt1.png")));

                    // Get the dimensions of the monitor
		    Main.screenBounds = Screen.getPrimary().getBounds();
		    
		    // Load the FXML
		    Parent layout = FXMLLoader.load(getClass().getResource("gui/main/Main.fxml"));

                    scene = new Scene(layout,layout.getLayoutY(), layout.getLayoutX());
                    scene.getStylesheets().add(getClass().getResource("gui/main/application.css").toExternalForm());
