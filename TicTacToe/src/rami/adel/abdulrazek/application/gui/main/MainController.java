package rami.adel.abdulrazek.application.gui.main;
...
import rami.adel.abdulrazek.application.Main;
...
import rami.adel.abdulrazek.application.services.Threads.BotPlayEasy;
...
//							System.out.println("Difficulty: " + Settings.EASY);
    ...
    void difficulty(ActionEvent event) {
		...
		// Switch robot image
		this.player1Img.setImage(new Image(getClass().getResourceAsStream("../../resources/images/" + MainController.currentDifficulty.get().toUpperCase() + ".png")));
